...
- [**Documentation**](https://dandrewbox.github.io/GM-EzConsole/)

---

### Installation

1. Download the latest release from the [releases page](https://github.com/DAndrewBox/GM-EzConsole/releases). **(Be sure you are downloading the correct version for your GameMaker version. Check the compatible versions in this table.)**
...
5. You can now use the extension in your project.
